package de.nwex.ignore.command;
...
public class ClientEntitySelector {
    ...
    public ClientEntitySelector(BiPredicate<Vec3d, Entity> filter, BiConsumer<Vec3d, List<Entity>> sorter, int limit, boolean senderOnly,
